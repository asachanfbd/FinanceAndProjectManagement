...
*   Description: db class handles all requests for database connection, creation and checking of tables existence in database, insertion and search of diff. queries. 
*/
  class db {
      private $host;
      private $uname;
